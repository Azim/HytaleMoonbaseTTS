...
public class TTSThread implements Runnable {
    ...
    public TTSThread(String commandPrefix, String commandSuffix) {
    ...
    public void run() {
        ...
        TTSNative.reset();
        TTSNative.speak(commandPrefix + message.text + commandSuffix); //FIXME append reset commands after the text. move pre- and post- commands to plugin config 
        TTSNative.sync();
